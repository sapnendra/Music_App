...
// convert second to minute in this format - 00:00
...
async function main() {
  ...
  // add an event Listener into seekbar
  ...
  // add event Listener for previous songs
  ...
  // add event Listener for next songs
  ...
  document
    ...
    .addEventListener("change", (ele) => {
      console.log("Setting Volume to: ", ele.target.value, "/ 100");
